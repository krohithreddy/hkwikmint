 ...
 */
public class MyErrorcodeRecyclerViewAdapter extends RecyclerView.Adapter<MyErrorcodeRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_errorcode, parent, false);
